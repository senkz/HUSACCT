...
public class AppliedRuleExceptionDomainService {
	...
	public void addExceptionToAppliedRule(long parentRuleId, String ruleType, String description, ModuleStrategy moduleFrom, ModuleStrategy moduleTo, String[] dependencies) {
		AppliedRuleFactory factory = new AppliedRuleFactory();
		AppliedRuleStrategy exceptionRule = factory.createRule(ruleType);
